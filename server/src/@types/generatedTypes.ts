...
export type AbletonLiveClip = {
  ...
  playingPosition?: Maybe<Scalars["Float"]>;
...
> = ResolversObject<{
  ...
  >;
  clips?: Resolver<
    Array<ResolversTypes["AbletonLiveClip"]>,
    ParentType,
    ContextType
  >;
}>;
